...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'sans_fonts' => ['vazirmatn','dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
			...
			'serif_fonts' => ['vazirmatn','dejavuserifcondensed', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
			...
			'mono_fonts' => ['vazirmatn','dejavusansmono', 'mono', 'monospace', 'freemono', 'liberationmono', 'courier', 'ocrb', 'ocr-b', 'lucidaconsole',
